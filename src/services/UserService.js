...
const { genneralaccess_token, genneralRefreshToken } = require('./JwtService')
const bcrypt = require('bcrypt')


const createUser = (newUser) => {
    return new Promise(async (resolve, reject) => {
        const {Fname,Lname, email,phone, password, confirmPassword} = newUser
        try {
...
const loginUser = (userLogin) => {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            const access_token = await genneralaccess_token({
                id: checkUser.id,
